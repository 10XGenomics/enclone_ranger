...
pub enum BarcodeFate {
    ...
    /// Delete duplicated barcodes within an exact subclonotype.
    /// Should not happen when enclone is invoked via cellranger
    DuplicatedBarcode,
...
impl BarcodeFate {
    pub fn label(&self) -> &'static str {
        match self {
            ...
            BarcodeFate::GelBeadContamination => "WHITEF",
            BarcodeFate::DuplicatedBarcode => "BC_DUP",
